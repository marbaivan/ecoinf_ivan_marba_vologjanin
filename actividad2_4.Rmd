...
```{r mapa_pdf, eval=!knitr::is_html_output(), echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', out.width='100%'}
library(dplyr)
library(sf)
library(leaflet)
library(gpx)
...
# GENERA LA IMATGE ESTÀTICA (NOMÉS AQUESTA PART CANVIA)
